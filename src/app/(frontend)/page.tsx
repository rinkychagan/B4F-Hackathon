    ...
    <>
      <div className="w-full  ">
        {/* {/* <div className={styles.container}>
          <button className="text-black bg-white hover:bg-black border hover:border-white hover:text-white font-medium text-sm px-5 py-2.5 text-center mt-44 w-28 ease-in-out duration-150 rounded-sm">
            Shop
          </button>
        </div>
        <div className="flex justify-center m-10 text-2xl rounded-sm">
          My Artwork
        </div>  */}
