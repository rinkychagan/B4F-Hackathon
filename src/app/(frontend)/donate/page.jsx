    ...
    <div className="flex flex-col">
      <div className="w-full flex justify-center align-center">
        <div className={styles.photo}>
          <h1 className="flex justify-center align-center text-6xl italic font-semibold mt-10 text-white dark:text-white">
      ...
      <div className="w-full flex flex-col justify-center align-center text-center">
        ...
        <p>
          ...
          to tell compelling stories through the textures, colors, and histories
          of the items I use. Your unwanted or unused items could find a second
          life in my artwork, helping to shape something truly unique and
          meaningful.
        </p>
        <p className="mt-10 mb-4 font-semibold text-xl">
          Why What Can You Donate?
        </p>
        <p className="mb-4 ">
          I am looking for a variety of materials, including but not limited to:
        </p>
